...
export function VaultDoor({ className = "", compact = false }) {
  ...
  return <svg className={`vault-door ${className}`} viewBox="0 0 500 500" aria-hidden="true" focusable="false">
    ...
    <text x="250" y="178" textAnchor="middle" fill="#c4c2a3" fontFamily="monospace" fontSize="10" fontWeight="700" letterSpacing="6">V A U L T</text>
    <text x="249" y="318" textAnchor="middle" fill="#071c24" opacity=".7" fontFamily="Impact, 'Arial Narrow', sans-serif" fontSize="163" fontWeight="900" letterSpacing="-5">76</text>
    <text x="247" y="315" textAnchor="middle" fill={`url(#${id}-gold)`} mask={`url(#${id}-stencil)`} fontFamily="Impact, 'Arial Narrow', sans-serif" fontSize="163" fontWeight="900" letterSpacing="-5">76</text>
